"""D-Bus next backend — subscribes to UDisks2 signals via dbus-next."""
...
from dbus_next.aio import MessageBus as _AioMessageBus
from dbus_next import BusType as _BusType
from dbus_next import Message as _Message
from dbus_next import MessageType as _MessageType
from dbus_next.signature import Variant as _Variant
...
class _DBusNextBackend(_Backend):
    """Monitors UDisks2 events via dbus-next."""
